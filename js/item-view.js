...
import { el, icon, isLowStock, isOutOfStock, formatLocation, formatDateTime } from "./utils.js";
...
const VIEW_KEYS = {
  storage: "workshop-storage-view-mode",
  search: "workshop-search-view-mode",
};
const DEFAULT_VIEW = { storage: "card", search: "list" };
