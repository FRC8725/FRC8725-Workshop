...
import { el, escapeHtml, hexToRgba, UNITS } from "./utils.js";
import { openModal, closeModal } from "./modal.js";
import { getWorkshopMap, getStructureById, createItem, updateItem } from "./data-service.js";
...
export async function openItemForm({ item = null, defaults = {}, onSaved } = {}) {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      console.error(err);
      notify.danger("儲存失敗：" + (err.message || "未知錯誤"));
